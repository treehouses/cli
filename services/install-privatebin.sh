...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 38 38">
  <defs/>
  <defs>
    <radialGradient id="a" cx="261" cy="240" r="341" gradientTransform="matrix(1.3 .00095 -.00102 1.4 -89.2 -86.2)" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#ff0"/>
      <stop offset="1" stop-color="#fa0"/>
    </radialGradient>
  </defs>
  <path fill="url(#a)" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="10.6" d="M250 3.16l-227 123-.42 247 227 124 227-123 .42-247zm-.711 97.9v.006c3.78 0 7.6.297 11.5.875 41.1 6.17 72.2 40.6 66.4 70.5-5.8 29.8-33.3 56-40.1 61.7s37.1 165 37.1 165h-149s46.2-157 36.5-165c-9.7-8.14-41.2-36.9-36.4-68.9 4.81-32.1 37.6-64 74.2-64.1z" transform="translate(1.4 1.38) scale(.0709)"/>
</svg>
EOF
}
